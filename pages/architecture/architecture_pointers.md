...
For more detailed information about the pointer data model and population guidance, see the [Pointer Data Model page](pointer_data_model_overview.html).
...
![Pointer transitions](images/architecture/pointer_transitions.png)
